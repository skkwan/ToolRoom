...
void validationPlots(TString sampleName, TString legend, TString inputDirectory, TString outputDirectory) {
  ...
  singleDistributionPlots("deltaR_ak4_leadingPair", cut, sampleName, treePath, inputDirectory, outputDirectory, "#DeltaR(close-by gen jets, nearest AK4 jet)", 40, 0, 1);
  singleDistributionPlots("pt_resolution_ak4_leadingPair", cut, sampleName, treePath, inputDirectory, outputDirectory, "pT resolution of close-by gen jets and nearest AK4 jet", 40, -2, 3);  
