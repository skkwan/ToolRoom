...
def makePlot(inputfile='limits_1.dat',
             ...
             smexpected=False,
             observed=False):
    print("...reading limits from {}".format(inputfile))
    if split_cv_xsecs: split_xsecs = False

    # Fill dataframes
    df    = pd.read_csv(inputfile, sep=",", index_col=None)
    # xsecs = pd.read_csv('xsecs_tH_ttH_WWZZttbb_K6.csv', sep=",", index_col=None)
    ...
    print("...saved plots in {}.pdf/.png".format(outfile))
